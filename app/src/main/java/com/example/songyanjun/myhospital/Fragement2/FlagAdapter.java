...
public class FlagAdapter extends RecyclerView.Adapter<FlagAdapter.AwardViewHolder>{
    ...
    public FlagAdapter(Context contexts, List<String> man1,List<String> man2_apart, List<String> man2, List<String> man3, List<String> time){
    ...
    @Override
    public void onBindViewHolder(FlagAdapter.AwardViewHolder holder, final int position) {
    ...
    @Override
    public FlagAdapter.AwardViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = inflater.inflate(R.layout.item_award_flag,parent,false);
        FlagAdapter.AwardViewHolder holder=new FlagAdapter.AwardViewHolder(view);
        return holder;
    }
